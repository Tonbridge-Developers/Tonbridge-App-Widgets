...
class PanopticMultiSelectFormField extends PanopticFormFieldDecoration<List<dynamic>> {
              ...
              return CheckboxListTile(
                ...
                onChanged: (bool? value) {
                  if (value!) {
                    ...
                    state
                        .didChange(state.value!.where((element) => element != item.value).toList());
                  }
                  if (onChanged != null) {
  ...
  @override
  PanopticFormFieldDecorationState<PanopticMultiSelectFormField, List<dynamic>> createState() =>
      PanopticMultiSelectFormFieldState();
}

class PanopticMultiSelectFormFieldState
    extends PanopticFormFieldDecorationState<PanopticMultiSelectFormField, List<dynamic>> {}
