...
Future<DateTime?> showBoardDateTimePicker<T extends BoardDateTimeCommonResult>({
  ...
  return await showModalBottomSheet<DateTime?>(
    ...
    constraints: BoxConstraints(
      maxWidth: _getWidth(context, pickerType),
      minWidth: _getWidth(context, pickerType),
    ),
    builder: (ctx) {
      return Padding(
...
double _getWidth(BuildContext context, DateTimePickerType pickerType) {
  if (PanopticExtension.getDeviceType(context) == DeviceType.large) {
